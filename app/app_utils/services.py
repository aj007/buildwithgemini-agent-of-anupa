...
def get_memory_service():
    ...
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID", "4959628122304544768")
    project = os.environ.get("GOOGLE_CLOUD_PROJECT", "qwiklabs-gcp-01-44253ac8b396")
    location = (
